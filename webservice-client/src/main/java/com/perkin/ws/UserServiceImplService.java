 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://ws.perkin.com/", wsdlLocation = "http://localhost:8080/demo/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://ws.perkin.com/", "UserServiceImplService");
    ...
    public UserServiceImpl getUserServiceImplPort() {
        return super.getPort(new QName("http://ws.perkin.com/", "UserServiceImplPort"), UserServiceImpl.class);
    }
    ...
    public UserServiceImpl getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.perkin.com/", "UserServiceImplPort"), UserServiceImpl.class, features);
    }
