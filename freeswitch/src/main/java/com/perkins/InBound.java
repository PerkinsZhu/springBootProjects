...
public class InBound {
    ...
    /**
     * 内链是监听状态的，可以订阅各种事件
     * 使用示例可参考： https://github.com/freeswitch/freeswitch-contrib.git
     * ..\freeswitch-contrib\dvarnes\java\esl-client\org.freeswitch.esl.client\src\test\java\org\freeswitch\esl\client\inbound\ClientTest.java
     *
